...
const Footer = () => (
  <footer className="bg-secondary text-secondary-foreground">
    ...
    <div className="border-t border-go-dark-lighter">
      ...
      <p className="text-center text-xs text-gray-400 py-4">Website developed by <a href="https://pixelmill.dev" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">Pixelmill.dev</a></p>
    </div>
  </footer>
);
