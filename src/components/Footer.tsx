...
const Footer = () => (
  <footer className="bg-secondary text-secondary-foreground">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            {services.slice(0, 8).map((s) => (
              <li key={s.slug}>
                <Link
                  ...
                  className="text-sm opacity-80 hover:text-primary hover:opacity-100 transition-colors"
                >
                  {s.name}
                </Link>
              </li>
        ...
        <div>
          ...
          <ul className="space-y-3">
            ...
            <li>
              <a href={`tel:${BUSINESS.phone}`} className="flex items-center gap-2 text-sm opacity-80 hover:text-primary transition-colors">
                <Phone className="h-4 w-4 flex-shrink-0 text-primary" />
                {BUSINESS.phoneFormatted}
              </a>
            </li>
            <li>
              <a href={`mailto:${BUSINESS.email}`} className="flex items-center gap-2 text-sm opacity-80 hover:text-primary transition-colors">
        ...
        <div>
          ...
          <ul className="space-y-2 mb-6">
            <li>
              <Link href="/despre-noi" className="text-sm opacity-80 hover:text-primary transition-colors">
                Despre Noi
              </Link>
            </li>
            <li>
              <Link href="/politica-confidentialitate" className="text-sm opacity-80 hover:text-primary transition-colors">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 text-sm opacity-80 hover:text-primary transition-colors"
          >
    ...
    <div className="border-t border-go-dark-lighter">
      <div className="container-content py-4 flex flex-col md:flex-row items-center justify-between text-xs opacity-60">
      ...
      <p className="text-center text-xs opacity-40 py-4">Website developed by Creative House.</p>
    </div>
  </footer>
);
