...
export const services: ServiceData[] = [
  {
    ...
    fullDescription: `La GoRacing, oferim servicii complete de mecanică și întreținere pentru toate mărcile și modelele de motociclete. Cu peste 20 ani de experiență în domeniu și autorizare RAR, suntem alegerea de încredere pentru motocicliștii din București și împrejurimi.
...
Lucrăm cu toate mărcile majore: MV AGUSTA, KTM, Husqvarna, Gas Gas, Honda, Yamaha, Kawasaki, Suzuki, BMW, Ducati, Triumph, Aprilia, CF MOTO și multe altele. Folosim echipamente profesionale de diagnoză și scule specialize pentru fiecare tip de motocicletă.

Timpul de execuție pentru o revizie completă variază, în funcție de complexitatea lucrărilor necesare. Recomandăm programarea din timp pentru a vă asigura un loc cât mai rapid.

De ce să alegi GoRacing? Suntem un service autorizat RAR, ceea ce înseamnă că lucrările noastre respectă cele mai înalte standarde de calitate și siguranță. Echipa noastră de mecanici experimentați are experiență vastă cu toate tipurile de motociclete. Oferim garanție pentru toate lucrările efectuate și folosim exclusiv piese originale sau de calitate echivalentă.`,
    faqs: [
      { question: "Cât costă o revizie completă la motocicletă?", answer: "Prețul unei revizii complete depinde de marca și modelul motocicletei, precum și de consumabilele necesare. Contactați-ne pentru o estimare precisă." },
      ...
      { question: "Ce mărci de motociclete acceptați la service?", answer: "Suntem un service multimarcă și lucrăm cu toate mărcile de motociclete: japoneze (Honda, Yamaha, Kawasaki, Suzuki), europene (KTM, BMW, Ducati, Triumph, Aprilia)" },
    ],
...
La GoRacing, înțelegem urgența situației și ne străduim să vă readucem motocicleta pe drum cât mai repede posibil, fără a face compromisuri în privința calității.`,
  ...
  },
  {
    ...
    fullDescription: `Motorul este inima motocicletei tale, iar la GoRacing îi acordăm toată atenția pe care o merită. Cu experiență de peste 20 ani în reparații și recondiționări de motoare, suntem echipați să rezolvăm orice problemă — de la reparații minore la recondiționări complete.
...
Prețurile pentru remapare ECU pornesc de la 1000 lei, în funcție de complexitatea intervenției și marca motocicletei. Diagnoză computerizată simplă (citire coduri eroare) pornește de la 100 lei.`,
    faqs: [
      ...
      { question: "Cât durează o remapare ECU?", answer: "O sesiune completă de remapare durează între 2 și 4 ore, incluzând diagnoza inițială, modificarea hărților ECU și testarea pe dinamometru (dyno) pentru verificare și ajustări fine. Dar sunt cazuri în care durează mult mai mult." },
...
Vă sfătuim să verificați anvelopele regulat: profilul minim legal este de 1.6mm, dar recomandăm înlocuirea la 2mm pentru siguranță optimă. Anvelopele mai vechi de 5 ani trebuie inspectate și eventual înlocuite, chiar dacă au profil suficient.`,
    faqs: [
      { question: "Cât durează schimbul de anvelope la motocicletă?", answer: "Schimbul complet (2 anvelope, montaj, echilibrare) durează aproximativ 60-90 de minute. Dacă aduceți roțile demontate, timpul se reduce semnificativ." },
...
Timpul de execuție: o sesiune de dyno standard durează aproximativ 1-2 ore. O sesiune completă de optimizare (dyno + remapare ECU) poate dura 3-5 ore. Prețurile pornesc de la 360 lei pentru o sesiune de măsurare și de la 1000 lei pentru o sesiune de optimizare.`,
    faqs: [
...
Durata unui proiect custom variază de la 2 la 18 luni, în funcție de complexitate. Proiectele mai simple (schimbare ghidon, șa, faruri, eșapament) pot fi finalizate în 1-2 săptămâni. Prețurile depind de amploarea transformării — contactați-ne pentru o estimare personalizată.`,
    faqs: [
      ...
      { question: "Cât durează un proiect custom complet?", answer: "Un proiect custom complet durează între 2 și 18 luni, în funcție de complexitatea transformării, disponibilitatea pieselor și finisajele dorite. Proiecte mai simple (modificări cosmetice) pot fi finalizate în 1-2 săptămâni." },
...
Durata unei restaurări complete variază de la 3 la 12 luni, în funcție de starea motocicletei și de disponibilitatea pieselor. Oferim și restaurări parțiale sau recondiționări cosmetice pentru cine dorește să păstreze patina originală.`,
    faqs: [
      ...
      { question: "Pot aduce o motocicletă clasică incompletă?", answer: "Absolut. Multe motociclete clasice ajung la noi în stare de proiect — incomplete, dezmembrate sau cu piese lipsă. Le evaluăm, stabilim un plan de restaurare și căutăm piesele necesare." },
    ],
...
Prețurile pornesc de la 220 lei/lună și includ depozitare + pregătire hibernare + pregătire sezon. Pachetele cu revizie completă sunt disponibile la prețuri preferențiale.`,
    faqs: [
